...
export const metadata = {
  title: "Crear cuenta · Plataforma Lujav",
  description: "Regístrate en Plataforma Lujav con tu correo empresarial.",
};

export default function SignupPage() {
  return (
    <div className="flex h-screen min-h-screen max-h-screen w-screen overflow-hidden bg-white">
      <div className="relative hidden w-1/2 lg:block">
        <div
          className="absolute inset-0 overflow-hidden rounded-r-3xl"
          style={{
            background:
              "linear-gradient(135deg, #dc2626 0%, #ef4444 25%, #b91c1c 50%, #991b1b 75%, #7f1d1d 100%)",
          }}
        >
        ...
        <div className="relative flex h-full flex-col justify-between p-16">
          <div>
            ...
            <p className="mt-4 max-w-md text-lg leading-7 text-white/80 drop-shadow">
              Crea tu cuenta y empieza a cotizar en segundos. Solo correos
      ...
      <div className="flex w-full flex-1 flex-col items-center justify-center overflow-hidden px-6 py-8 sm:px-16 lg:w-1/2">
        <div className="flex w-full max-w-md items-start justify-center overflow-hidden">
          <SignupForm />
        </div>
      </div>
    </div>
